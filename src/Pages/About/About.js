    ...
    return (
        <div>
            ...
            <Container sx={{ marginY: "60px" }}>
                <Box sx={{ flexGrow: 1 }}>
                    <Typography variant="h4" sx={{ textAlign: "center", margin: "60px" }} >
                        Our Team
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: "auto auto auto auto", justifyContent: "space-between", marginTop: "30px" }}>
